...
//typescript for Form functions
//Forms: ChangeEvent => input function
//Forms: FormEvent => submit function 
...
const SignUpForm = () =>
{
    ...
    const handleSubmit = async(event: FormEvent<HTMLFormElement>)=>{
        ...
        if((error as AuthError).code === AuthErrorCodes.EMAIL_EXISTS) //this is a good sign when as a coder you recieve this because it means its logging in the user correctly usually
         {alert("Email already in use");}
        else{console.log('user creation encountered an error', error);}
            console.log('error creation of user', (error as Error).message);
        }
    }
    return (
